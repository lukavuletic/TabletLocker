...
boolean writeEnabled = false; // for writing writeData on RFID card 

uchar  writeData[16]={9, 8, 7, 6, 5, 4, 3, 2, 1, 0, 9, 0, 0, 0, 0, 3};  //100
int k;
...
/* function for array comparison between serial and database */

bool strcmp1(uchar *a, uchar *b){
  bool same = true;
  for(int i = 0; a[i] != 0; ++i){
    if(a[i]!=b[i]-'0'){
      same = false;
